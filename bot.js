//ALTYAPI BOTFLİX CODE ' A AİTTİR ÇALINMASI SONUCU İŞLEM UYGULANACAKTIR - REWARON
...
client.on('message', async message => {
  ...
  return message.channel.send(" Bu Kodu `Yönetici` Yetkisi Olan Kişi Kullanabilir.");
    ...
    .then((collected) => {
   message.guild.createChannel('|▬▬|REWARON|▬▬|', 'category', [{
  id: message.guild.id,
  deny: ['SEND_MESSAGES']
}])    
...
.then(channel =>
 channel.setParent(message.guild.channels.find(channel => channel.name === "|▬▬|REWARON|▬▬|")));
...
.then(channel =>
            ...
            .then(channel => channel.setParent(message.guild.channels.find(channel => channel.name === "|▬▬|REWARON|▬▬|")));
